...
1. [Download hs unity plugin](https://appodeal-unity.s3.amazonaws.com/Appodeal-Unity-HS-Plugin-2.0.1-25.08.2021.unitypackage)

## Import SDK

### Import Appodeal Holistic Solution plugin

To import the Appodeal-Unity-HS-Plugin-2.0.1-25.08.2021.unitypackage, double-click on the Appodeal-Unity-HS-Plugin-2.0.1-25.08.2021.unitypackage, or go to Assets → Import Package → Custom Package. Keep all the files in the Importing Package window selected, and click Import .
