...
namespace AppodealAds.Unity.Dummy
{
    ...
    public class DummyClient : IAppodealAdsClient
    {
        ...
        {
            Debug.Log("Call to Appodeal.initialize on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call Appodeal.isInitialized on not supported platform." + DummyMessage);
            return false;
        }

        public bool show(int adTypes)
        {
            Debug.Log("Call to Appodeal.show on not supported platform." + DummyMessage);
            return false;
        }
        ...
        {
            Debug.Log("Call to Appodeal.showBannerView on not supported platform." + DummyMessage);
            return false;
        }

        public bool showMrecView(int YAxis, int XGravity, string Placement)
        {
            Debug.Log("Call to Appodeal.showMrecView on not supported platform." + DummyMessage);
            return false;
        }
        ...
        {
            Debug.Log("Call to Appodeal.cache on not supported platform." + DummyMessage);
        }

        public void hide(int adTypes)
        {
            Debug.Log("Call to Appodeal.hide on not supported platform." + DummyMessage);
        }

        public void hideBannerView()
        {
            Debug.Log("Call to Appodeal.hideBannerView on not supported platform." + DummyMessage);
        }

        public void hideMrecView()
        {
            Debug.Log("Call to Appodeal.hideMrecView on not supported platform." + DummyMessage);
        }

        public bool isPrecache(int adTypes)
        {
            Debug.Log("Call to Appodeal.isPrecache on not supported platform." + DummyMessage);
            return false;
        }

        public void setAutoCache(int adTypes, bool autoCache)
        {
            Debug.Log("Call to Appodeal.setAutoCache on not supported platform." + DummyMessage);
        }

        public void setSmartBanners(bool value)
        {
            Debug.Log("Call to Appodeal.setSmartBanners on not supported platform." + DummyMessage);
        }

        public void setBannerAnimation(bool value)
        {
            Debug.Log("Call to Appodeal.setBannerAnimation on not supported platform." + DummyMessage);
        }

        public void setBannerBackground(bool value)
        {
            Debug.Log("Call to Appodeal.setBannerBackground on not supported platform." + DummyMessage);
        }

        public void setTabletBanners(bool value)
        {
            Debug.Log("Call to Appodeal.setTabletBanners on not supported platform." + DummyMessage);
        }

        public void setBannerRotation(int leftBannerRotation, int rightBannerRotation)
        {
            Debug.Log("Call to Appodeal.setBannerRotation on not supported platform." + DummyMessage);
        }

        public void setTesting(bool test)
        {
            Debug.Log("Call to Appodeal.setTesting on not supported platform." + DummyMessage);
        }

        public void setLogLevel(Appodeal.LogLevel logging)
        {
            Debug.Log("Call to Appodeal.setLogLevel on not supported platform." + DummyMessage);
        }

        public void setChildDirectedTreatment(bool value)
        {
            Debug.Log("Call to Appodeal.setChildDirectedTreatment on not supported platform." + DummyMessage);
        }

        public void updateConsent(bool value)
        {
            Debug.Log("Call to Appodeal.updateConsent on not supported platform." + DummyMessage);
        }

        public void disableNetwork(string network)
        {
            Debug.Log("Call to Appodeal.disableNetwork on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.muteVideosIfCallsMuted on not supported platform." + DummyMessage);
        }

        public void showTestScreen()
        {
            Debug.Log("Call to Appodeal.showTestScreen on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.canShow on not supported platform." + DummyMessage);
            return false;
        }
        ...
        {
            Debug.Log("Call to Appodeal.setSegmentFilter on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.setCustomFilter on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.trackInAppPurchase on not supported platform." + DummyMessage);
        }

        public string getRewardCurrency(string placement)
        {
            Debug.Log("Call to Appodeal.getRewardCurrency on not supported platform." + DummyMessage);
            return "USD";
        }

        public double getRewardAmount(string placement)
        {
            Debug.Log("Call to Appodeal.getRewardAmount on not supported platform." + DummyMessage);
            return 0;
        }
        ...
        {
            Debug.Log("Call to Appodeal.getPredictedEcpm on not supported platform." + DummyMessage);
            return 0;
        }
        ...
        {
            Debug.Log("Call to Appodeal.setExtraData(string key, int value) on not supported platform." + DummyMessage);
        }

        public void setExtraData(string key, double value)
        {
            Debug.Log(
                "Call to Appodeal.setExtraDatastring key, double value) on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.setInterstitialCallbacks on not supported platform." + DummyMessage);
        }

        public void setNonSkippableVideoCallbacks(INonSkippableVideoAdListener listener)
        {
            Debug.Log("Call to Appodeal.setNonSkippableVideoCallbacks on not supported platform." + DummyMessage);
        }

        public void setRewardedVideoCallbacks(IRewardedVideoAdListener listener)
        {
            Debug.Log("Call to Appodeal.setRewardedVideoCallbacks on not supported platform." + DummyMessage);
        }

        public void setBannerCallbacks(IBannerAdListener listener)
        {
            Debug.Log("Call to Appodeal.setBannerCallbacks on not supported platform." + DummyMessage);
        }
        ...
        {
            Debug.Log("Call to Appodeal.setUseSafeArea on not supported platform." + DummyMessage);
        }

        public bool isAutoCacheEnabled(int adType)
        {
            Debug.Log("Call to Appodeal.isAutoCacheEnabled on not supported platform." + DummyMessage);
            return false;
        }
        ...
        {
            Debug.Log("Call to Appodeal.setUserId on not supported platform." + DummyMessage);
        }

        public void setUserAge(int age)
        {
            Debug.Log("Call to Appodeal.setUserAge on not supported platform." + DummyMessage);
        }

        public void setUserGender(UserSettings.Gender gender)
        {
            Debug.Log("Call to Appodeal.setGender on not supported platform." + DummyMessage);
        }
